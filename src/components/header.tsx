      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <Link href="/" className="text-2xl font-bold text-gray-900">
            TechTalent<span className="text-primary">Solutions</span>
          </Link>
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link href="/employers" className="text-gray-700 hover:text-primary font-medium">
              For Employers
            </Link>
            <Link href="/job-seekers" className="text-gray-700 hover:text-primary font-medium">
              For Job Seekers
            </Link>
